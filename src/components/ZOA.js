            ...
            <section className="relative p-4 top-36 w-full max-w-full mx-auto " style={{ zIndex: 1 }}>
                ...
                >
                    ...
                    <div className="justify-center items-center w-80 h-20 absolute left-0 bottom-0 bg-white rounded-tr-3xl  rounded-br-none px-8 py-4 text-black text-base font-sans flex flex-col shadow-md" style={{ minWidth: 220 }}>
                        <span className="text-sm mb-1">Home / Zalo Official Accout</span>
                    </div>
    ...
    `}
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 xl:gap-x-10 gap-y-6 mt-[-20px] sm:mt-0 mb-10">
                        ...
                        {/* Feature 1 */}
                        <article className="flex flex-col items-center text-center space-y-3 xl:space-y-4 max-w-[180px] justify-self-center">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg font-roboto text-gray-900 leading-tight">An toàn thông tin theo tiêu chuẩn quốc tế</h3>
                        </article>
                        ...
                        <article className="flex flex-col items-center text-center space-y-4 xl:space-y-6 max-w-xs">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg font-roboto text-gray-900 leading-tight">Chứng nhận xác thực giúp đảm bảo uy tín doanh nghiệp</h3>
                        </article>
                        ...
                        <article className="flex flex-col items-center text-center space-y-4 xl:space-y-6 max-w-xs">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg font-roboto text-gray-900 leading-tight">Chi phí hợp lý và minh bạch cho từng dịch vụ</h3>
                        </article>
                        {/* Feature 4 */}
                        <article className="flex flex-col items-center text-center space-y-4 xl:space-y-6 max-w-xs">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg font-roboto text-gray-900 leading-tight">Tối ưu trải nghiệm khách hàng với đa dạng tính năng tương tác</h3>
                        </article>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 xl:gap-x-16 gap-y-6">
                        ...
                        <article className="flex flex-col items-center text-center space-y-3 xl:space-y-4 max-w-[180px] justify-self-center">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg font-roboto text-gray-900 leading-tight">Tối ưu hiệu quả vận hành với công cụ quản lý mạnh mẽ</h3>
                        </article>
                        ...
                        <article className="flex flex-col items-center text-center space-y-4 xl:space-y-6 max-w-xs">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg  text-gray-900 font-roboto leading-tight">Dễ dàng kết nối với hệ thống, nền tảng của doanh nghiệp hoặc bên thứ ba</h3>
                        </article>
                         {/* Feature 7 */}
                        <article className="flex flex-col items-center text-center space-y-4 xl:space-y-6 max-w-xs">
                            <img
                                ...
                                className="w-14 h-14"
                            />
                            <h3 className="text-base md:text-lg  text-gray-900 font-roboto leading-tight">Tiếp cận hệ sinh thái đa dạng giải pháp của Zalo</h3>
                        </article>
                    </div>
                </div>
            </section>
             {/* Pricing table */}
                    <section className="relative flex-grow max-w-[85rem] mx-auto px-6 sm:px-8 lg:px-12 ">
                        ...
                        <h1 className="text-4xl 0.5xl:text-6xl max-w-xl mb-4 leading-tight font-roboto 0.5xl:mt-28" style={{marginLeft:'110px'}}>Bảng giá dịch vụ OA</h1>
        ...
        <div className="w-full max-w-xs md:hidden">
            ...
            <div className="custom-pagination-zalo-products mt-6 flex justify-center"></div>
                ...
                {/* Customer of Zatify */}
                            ...
                            <section className="mt-20 relative flex-grow max-w-[85rem] mx-auto px-6 sm:px-8 lg:px-12 pb-16">
